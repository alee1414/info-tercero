...
use App\Models\HistorialPagosModel; // Usamos el nuevo modelo HistorialPagosModel

class HistorialPagos extends ResourceController
{
    use ResponseTrait;

    protected $modelName = 'App\Models\HistorialPagosModel'; // Cambiado a HistorialPagosModel
    ...
    public function show($id = null)
    {
        ...
        if ($pago) {
            ...
            return $this->failNotFound('Registro de pago no encontrado'); // Mensaje adaptado
        }
    }
